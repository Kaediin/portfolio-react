    ...
    return (
        <section id="cvbiography">
            ...
            <p>My passion for software extends beyond the boundaries of base-functionality. I always strive to help and
                ...
                to a
                sustainable society – helping companies achieve their sustainable goals and being fully committed to
                working
                towards a better future for our society.</p>
        </section>
    )
}

export default Resumebiography;
